...
if (isset($_POST['submit'])) {
    ...
    $role=$_POST['role'];
    $okey = $con->query("update users set login='$login',name='$name', surname='$surname', date='$date', tel='$tel', mail='$mail', image='$rasm' , role='$role' WHERE id='$new_id'");
    if ($okey)
        header('location:index.php');
}
?>
...
<div class="container">
    <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group has-error has-feedback">
            ...
            <div class="col-sm-10">
                <input value="<?= $result['role'] ?>" type="text" class="form-control" id="inputError" name="role">
                <i class="glyphicon glyphicon-user form-control-feedback"></i>
            </div>
        </div>
