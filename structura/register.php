    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
                <form role="form" id="forma" action="sql/register.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="pass2"><span class="glyphicon glyphicon-eye-close"></span>two password</label>
